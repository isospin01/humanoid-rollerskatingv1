...
class RslRlVecEnvWrapper(VecEnv):
  ...
  @property
  def amp_active_mask(self) -> torch.Tensor | None:
    return getattr(self.unwrapped, "amp_active_mask", None)

  @amp_active_mask.setter
  def amp_active_mask(self, value: torch.Tensor | None) -> None:
    self.unwrapped.amp_active_mask = value
