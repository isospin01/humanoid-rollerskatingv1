...
def get_base_metadata(
  ...
  joint_name_to_index = {jname: idx for idx, jname in enumerate(robot.joint_names)}
  actuated_joint_indices = [joint_name_to_index[jname] for jname in actuated_joint_names]
  ...
  return {
    ...
    "default_joint_pos": robot.data.default_joint_pos[0, actuated_joint_indices].cpu().tolist(),
